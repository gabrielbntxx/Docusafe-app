  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-neutral-900">{t("myFolders")}</h1>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 p-4">
          <div className="w-full max-w-md rounded-2xl bg-white p-6 shadow-soft-xl">
            <div className="mb-4 flex items-center justify-between">
              ...
              <button onClick={cancelEdit} className="text-neutral-400 hover:text-neutral-600">
                <X className="h-5 w-5" />
              </button>
            </div>
                  ...
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <button
                      ...
                      className={`relative h-6 w-11 rounded-full transition-colors ${
                        enablePin ? "bg-primary-600" : "bg-neutral-300"
                      }`}
                    >
                      <div
              ...
              <div className="space-y-2">
                {filteredDocuments.map((doc) => {
                  ...
                  return (
                    <div
                      key={doc.id}
                      className="flex items-center gap-4 rounded-xl border border-neutral-200 bg-neutral-50 p-3 transition-all hover:bg-white hover:shadow-soft"
                    >
                      ...
                      <div className="relative">
                        ...
                        {movingDocumentId === doc.id && (
                          <div className="absolute right-0 top-full z-10 mt-1 w-48 rounded-xl border border-neutral-200 bg-white py-2 shadow-soft-lg">
