    ...
    <div className="min-h-screen overflow-x-hidden">
      ...
      <div className="mb-6">
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            <h1 className="text-xl lg:text-2xl font-bold text-neutral-900 dark:text-white">{t("notificationsTitle")}</h1>
        ...
        {unreadCount > 0 && (
          <button
            ...
            className="mt-3 flex items-center gap-2 rounded-xl bg-blue-100 px-4 py-2 text-sm font-medium text-blue-600 transition-colors hover:bg-blue-200 dark:bg-blue-500/20 dark:text-blue-400 dark:hover:bg-blue-500/30"
          >
      ...
      <div className="space-y-3">
        {loading ? (
          <div className="flex items-center justify-center py-12">
            <div className="h-10 w-10 animate-spin rounded-full border-4 border-neutral-200 border-t-blue-600 dark:border-neutral-700 dark:border-t-blue-400"></div>
          </div>
        ) : notifications.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-16 text-center rounded-2xl bg-white dark:bg-neutral-800/50">
              ...
              <div className="flex gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-start justify-between gap-2">
                    ...
                    {!notification.read && <div className="mt-2 h-2.5 w-2.5 flex-shrink-0 rounded-full bg-blue-500" />}
                  </div>
