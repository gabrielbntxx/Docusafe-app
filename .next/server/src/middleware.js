...
function cleanupStore() {
    ...
    for (const [key, data] of loginAttempts.entries()){
        if ((!data.blockedUntil || data.blockedUntil < now) && now - data.firstAttempt > 60 * 60 * 1000) {
